    ...
    <header>
      <nav className="navbar">
        ...
        <div className="navbarLinks">
          ...
          <NavLink to="#">{t('salesCall')}</NavLink>
        </div>
        <div className="navbarActions">
          <div
            className={
              'trackShipment' + (showSearch ? ' trackShipmentAtive' : '')
            }
          ...
          >
            ...
            {showSearch && (
              <>
                <ArrowBackIosIcon sx={{ fontSize: 12, color: '#E30613' }} />

                <div className="trackShipmentSearch">
                  <p>{t('trackShipment')}</p>

                  <form
                    onSubmit={handleSearchSubmit}
                    className="trackShipmentSearchInput"
                  >
                    <input
                      type="text"
                      name="searchNumber"
